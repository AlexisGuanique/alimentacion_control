        ...
        return (
          <div key={day} className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className={`text-sm font-bold ${overGoal ? "text-red-500" : "text-gray-700"}`}>
                  {dayTotal.toFixed(0)} kcal
                </span>
                <span className="text-xs text-gray-400">{dayMeals.length} comida{dayMeals.length !== 1 ? "s" : ""}</span>
            ...
            {isOpen && (
              <div className="border-t border-gray-100 divide-y divide-gray-50">
                {dayMeals.map((meal) => (
                  <div key={meal.id} className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50/50 transition-colors group">
                    ...
                    <span className="text-sm font-semibold text-gray-700 flex-shrink-0">{meal.calories.toFixed(0)} kcal</span>
